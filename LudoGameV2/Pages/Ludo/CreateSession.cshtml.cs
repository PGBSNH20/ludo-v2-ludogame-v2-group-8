...
namespace LudoGameV2.Pages.Ludo
{
    ...
    public class CreateSessionModel : PageModel
    {
        ...
        public IActionResult OnPostAsync(string fromEmail, string toEmail)
        {
            if (!ModelState.IsValid)
            {
                return Page();
            }
            var client = new RestClient($"https://localhost:44393/api/SendEmail/SendEmail/?{fromEmail}{toEmail}");
            client.Timeout = -1;
